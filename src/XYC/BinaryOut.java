 ...
 * type variables (<tt>boolean</tt>, <tt>byte</tt>, <tt>char</tt>, <tt>int</tt>,
 * <tt>long</tt>, <tt>float</tt>, and <tt>double</tt>) to sequences of bits and
 ...
 * bits.
 * <p>
 * The client should not intermixing calls to <tt>BinaryOut</tt> with calls to
 * <tt>Out</tt>; otherwise unexpected behavior will result.
 *
